...
|------|------|------|
| id | int | 自增主键 |
| deviceId | int | 关联 wearable_device.id |
| data | text | JSON 格式体征数据 |
| createTime | datetime | 插入时间 |

**data 列 JSON 格式示例**：

```json
{"类型":"血压","高压":128,"低压":82,"脉搏":72,"风险等级":"正常"}
{"类型":"心率","心率值":72,"心率状态":"静息"}
{"类型":"血氧","血氧饱和度":98,"心率":70}
{"类型":"体温","体温":36.5,"皮肤温度":33.2}
{"类型":"步数","步数":8523,"卡路里":320,"距离_米":5800}
{"类型":"睡眠","入睡时间":"23:15","醒来时间":"07:30","深睡_分钟":120,"浅睡_分钟":280}
```
