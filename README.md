...
| id | device_sign | type |
|----|-------------|------|
| 1 | VP-W680_B8:27:EB:6A:F3:11 | 1 |
| 2 | VP-W680_B8:27:EB:9C:D7:4E | 1 |
| 3 | VP-W680_B8:27:EB:3B:A8:72 | 1 |
...
|------|------|------|
| id | bigint | 自增主键 |
| deviceId | bigint | 设备品类 ID（1=手表），关联 wearable_device |
| data | text | 大 JSON：按 10 类数据分组，每类是历史测量数组 |
| createTime | datetime | 数据采集日期 |

当前数据（12 行：3 台手表 × 4 天）：

| id | deviceId | createTime | 说明 |
|----|----------|-----------|------|
| 1,2,3 | 1 | 2026-04-09 | 初始数据 |
| 4,7,10 | 1 | 2026-04-06 | 3 台手表第 1 天 |
| 5,8,11 | 1 | 2026-04-07 | 3 台手表第 2 天 |
| 6,9,12 | 1 | 2026-04-08 | 3 台手表第 3 天 |
